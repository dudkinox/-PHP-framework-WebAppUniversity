...
(function (d) {
  "function" === typeof define && define.amd
    ? define(["jquery", "datatables.net"], function (m) {
        return d(m, window, document);
      })
    : "object" === typeof exports
    ? (module.exports = function (m, l) {
        m || (m = window);
        if (!l || !l.fn.dataTable) l = require("datatables.net")(m, l).$;
        return d(l, m, m.document);
      })
  ...
  function r(a, b, c) {
    ...
    if (n[e]) {
      for (
        var a = a.cell(b, c).node(),
          c = n[e][0].parentNode.childNodes,
          b = [],
          d = 0,
          g = c.length;
        d < g;
        ...
        b.push(c[d]);
      c = 0;
      for (d = b.length; c < d; c++) a.appendChild(b[c]);
      n[e] = q;
    }
  }
  ...
  d.extend(i.prototype, {
    _constructor: function () {
      ...
      d(m).on(
        ...
        o.util.throttle(function () {
          var b = d(m).innerWidth();
          b !== e && (a._resize(), (e = b));
        })
      );
      c.oApi._fnCallbackReg(c, "aoRowCreatedCallback", function (c) {
        -1 !== d.inArray(!1, a.s.current) &&
          d(">td, >th", c).each(function (c) {
            c = b.column.index("toData", c);
            !1 === a.s.current[c] && d(this).css("display", "none");
          });
      });
      b.on("destroy.dtr", function () {
        b.off(".dtr");
        d(b.table().body()).off(".dtr");
        d(m).off("resize.dtr orientationchange.dtr");
        b.cells(".dtr-control").nodes().to$().removeClass("dtr-control");
        d.each(a.s.current, function (b, c) {
          !1 === c && a._setColumnVis(b, !0);
        });
      });
    ...
    _columnsVisiblity: function (a) {
      var b = this.s.dt,
        ...
        j = d.map(c, function (c, e) {
          return !1 === b.column(e).visible()
            ? "not-visible"
            : c.auto && null === c.minWidth
            ? !1
            : !0 === c.auto
            ? "-"
            : -1 !== d.inArray(a, c.includeIn);
        }),
        h = 0;
      e = 0;
      for (f = j.length; e < f; e++) !0 === j[e] && (h += c[e].minWidth);
      e = b.settings()[0].oScroll;
      e = e.sY || e.sX ? e.iBarWidth : 0;
      h = b.table().container().offsetWidth - e - h;
      e = 0;
      for (f = j.length; e < f; e++) c[e].control && (h -= c[e].minWidth);
      var s = !1;
      e = 0;
      for (f = g.length; e < f; e++) {
        ...
        "-" === j[k] &&
          !c[k].control &&
          c[k].minWidth &&
          (s || 0 > h - c[k].minWidth ? ((s = !0), (j[k] = !1)) : (j[k] = !0),
          (h -= c[k].minWidth));
      }
      g = !1;
      e = 0;
      for (f = c.length; e < f; e++)
        if (!c[e].control && !c[e].never && !1 === j[e]) {
          g = !0;
          break;
        }
      e = 0;
      for (f = c.length; e < f; e++)
        c[e].control && (j[e] = g), "not-visible" === j[e] && (j[e] = !1);
      -1 === d.inArray(!0, j) && (j[0] = !0);
      return j;
    },
    _classLogic: function () {
        ...
        g = function (c, d, g, k) {
          if (g)
            if ("max-" === g) {
              k = a._find(d).width;
              d = 0;
              for (g = b.length; d < g; d++) b[d].width <= k && f(c, b[d].name);
            } else if ("min-" === g) {
              k = a._find(d).width;
              d = 0;
              for (g = b.length; d < g; d++) b[d].width >= k && f(c, b[d].name);
              ...
              if ("not-" === g) {
                ...
                for (g = b.length; d < g; d++)
                  -1 === b[d].name.indexOf(k) && f(c, b[d].name);
              }
            }
      ...
      e.each(function (a, c) {
        for (
          var e = a.className.split(" "), f = !1, i = 0, m = e.length;
          i < m;
          i++
        ) {
          var l = e[i].trim();
          ...
          function (c) {
            if (
              ...
              c.type === "click"
                ...
                : c.type === "mouseup" &&
                  d(this).trigger("blur").css("outline", "");
            }
          }
        );
    },
    _detailsObj: function (a) {
      var b = this,
        c = this.s.dt;
      return d.map(this.s.columns, function (e, f) {
        if (!e.never && !e.control) {
          var g = c.settings()[0].aoColumns[f];
          return {
            className: g.sClass,
            columnIndex: f,
            data: c.cell(a, f).render(b.c.orthogonal),
            hidden: c.column(f).visible() && !b.s.current[f],
            rowIndex: a,
            title:
              null !== g.sTitle ? g.sTitle : d(c.column(f).header()).text(),
          };
        }
      });
    },
    ...
    _resize: function (a) {
      ...
      var k = this._columnsVisiblity(g);
      this.s.current = k;
      f = !1;
      h = 0;
      for (e = j.length; h < e; h++)
        if (
          !1 === k[h] &&
          !j[h].never &&
          !j[h].control &&
      ...
      d(c.table().node()).toggleClass("collapsed", f);
      var l = !1,
        n = 0;
      c.columns()
        .eq(0)
        .each(function (c, d) {
          !0 === k[d] && n++;
          if (a || k[d] !== i[d]) (l = !0), b._setColumnVis(c, k[d]);
        });
      l &&
        (this._redrawChildren(),
        d(c.table().node()).trigger("responsive-resize.dt", [
          c,
          this.s.current,
        ]),
        0 === c.page.info().recordsDisplay &&
          d("td", c.table().body()).eq(0).attr("colspan", n));
      b._controlClass();
    },
    _resizeAuto: function () {
      ...
      if (
        ...
        g.each(function (d) {
          d = a.column.index("fromVisible", d);
          b[d].minWidth = this.offsetWidth || 0;
        });
        c.remove();
      }
    },
    _responsiveOnlyHidden: function () {
      var a = this.s.dt;
      return d.map(this.s.current, function (b, d) {
        return !1 === a.column(d).visible() ? !0 : b;
      });
    },
  ...
  p.register("responsive.hasHidden()", function () {
    ...
    return a._responsive
      ? -1 !== d.inArray(!1, a._responsive._responsiveOnlyHidden())
      : !1;
  });
  p.registerPlural(
    ...
    function () {
      return this.iterator(
        "column",
        function (a, b) {
          return a._responsive ? a._responsive._responsiveOnlyHidden()[b] : !1;
        },
        1
      );
    }
  ...
  d.fn.DataTable.Responsive = i;
  d(l).on("preInit.dt.dtr", function (a, b) {
    if (
      "dt" === a.namespace &&
