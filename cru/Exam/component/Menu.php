                            ...
                            <div class="d-flex align-items-end mb-7">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex flex-column text-center">
                                        <h1><a class="text-dark font-weight-bold text-hover-primary font-size-h1 mb-0">สอบเสนอหัวข้อ</a></h1>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6" onclick="link_menu('Exam/?menu=2')">
                    <div class="card card-custom gutter-b card-stretch cursor-pointer" data-tilt data-tilt-max="30" data-tilt-glare data-tilt-max-glare="0.55">
                        <div class="card-body pt-4">
                            <div class="d-flex align-items-center mb-7">
                                <div class="d-flex flex-column text-center">
                                    <a class="text-dark font-weight-bold text-hover-primary font-size-h1 mb-0">ขอสอบประเมินผลโครงงานวิจัยทางวิทยาการคอมพิวเตอร์</a>
                                    <span class="text-muted font-weight-bold">กรอกฟอร์ม, เลือกกรรมการ, รออนุมัติ</span>
                                </div>
                            </div>
                        </div>
                    </div>
