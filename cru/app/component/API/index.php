...
if (!$conn) {
    ...
    if ($comment == 1) {
        ...
        $sql = "INSERT INTO comment (ID_student, Comment, Teacher_Name, Topic)
        VALUES ('" . $id_student . "', '" . $compose_textarea . "', '" . $Name_teacher . "', '" . $topic . "')";
        ...
        $sql_status = "UPDATE status SET Status='ยังไม่ดำเนินการสอบเสนอหัวข้อ', Level = 2 WHERE id_student='" . $id_student . "'";
