...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block" data-aos="fade-down" data-aos-delay="2000">
            <a href="?profile=1" class="nav-link">Home</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block d-none d-sm-inline-block" data-aos="fade-down" data-aos-delay="2500">
            <a href="?person=1" class="nav-link">Contact</a>
        </li>
    </ul>

    <form class="form-inline ml-3 d-none d-sm-inline-block" data-aos="fade-down" data-aos-delay="3000">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#">
                ...
                <span class="badge badge-warning navbar-badge"><?php //echo $sum; 
                                                                ?></span>
            </a>
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <span class="dropdown-item dropdown-header"><?php //echo $sum; 
                                                            ?> Notifications </span>
                <?php
                ...
                <a href="#" class="dropdown-item">
                    ...
                    <span class="float-right text-muted text-sm"><?php //echo $Comment_Alert; 
                                                                    ?></span>
                </a>
                <div class="dropdown-divider"></div>
