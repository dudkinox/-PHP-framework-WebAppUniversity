<div class="card">
    <div class="card-header bg-warning">
        <h3 class="card-title">รายชื่อสอบความก้าวหน้าครั้งที่ 1</h3>
    </div>
    <div class="card-body text-center text-dark">
        <table id="example1" class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                <?php
                $sql_consultant = "SELECT * FROM exam_progress 
                ...
                WHERE no_std = '" . $row_consultant["id_student"] . "'";
                        ...
                        } else if ($row_consultant["status"] == "ยื่นสอบก้าวหน้าครั้งที่ 2") {
                            echo '<span style = "color: #990000;">' . $row_consultant["status"] . '</span>';
                        } else {
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer ">
                                        <button type="button" class="btn btn-primary" onclick="approve3('<?php echo $row_consultant['id_student']; ?>')">อนุมัติ</button>
